...
const DEFAULT_PRESETS = [
  ...
  // ── CORTEX presets ─────────────────────────────────────────────────────────
  {
    ...
    createdAt:  null,
    usageCount: 0,
    tags:       ['summarise', 'translate', 'rewrite', 'analyse', 'explain'],
  ...
  },
  {
    ...
    actions:    [{ node: 'CORTEX', command: 'pool_status', params: {} }],
    source:     'default',
    createdAt:  null,
    usageCount: 0,
    tags:       ['engine', 'status'],
